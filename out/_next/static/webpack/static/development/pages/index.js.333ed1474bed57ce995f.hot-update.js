...
function (_React$Component) {
  ...
  _createClass(Movie, [{
    ...
    value: function componentDidMount() {
      ...
      console.log(movie); // let req = fetch(`https://api.themoviedb.org/3/movie/${movie.id}?api_key=aeb209169cc4a9768d6b47be200b3374&year=2018&language=es`)
      // let { genres } = req.json()
      // this.genres=genres
    }
  }, {
...
//# sourceMappingURL=index.js.333ed1474bed57ce995f.hot-update.js.map